      ...
      <div class="row">
          <div class="col-xs-12 col-md-12 col-md-offset-1">
            ...
            <div class="row">
                ...
                <div class="col-md-1 col-sm-1" style="text-align: right;width: 5px">:</div>
                <div class="col-md-9 col-sm-9" style="padding-left: 25px"><?php echo $bulan ?>
...
<div class="box box-primary">
  <div class="box-header with-border">
    ...
    <h3 class="box-title">Laporan Kegiatan OPD</h3>
  </div>
  <div class="box-body">
    <div class="row">
        ...
        <table class="table table-bordered " style="font-size: 12px; ">
          <thead >
            <tr class="bg-gray-active color-palette">
              <th rowspan="2" style="vertical-align : middle;text-align:center; ">PAGU OPD TAHUN  <span style=" text-transform: uppercase;"><?php echo $tahun ?></span></th>
              <th colspan="3" style="vertical-align : middle;text-align:center; " >REALISASI s/d BULAN  <span style=" text-transform: uppercase;"><?php echo $bulan ?></span></th>
              <th colspan="3" style="vertical-align : middle;text-align:center; " >REALISASI BULAN  <span style=" text-transform: uppercase;"><?php echo $bulan ?></span></th>
     ...
     if(empty($program[0])){
       echo '<div class="callout callout-danger">
               <h4><i class="icon fa fa-ban"></i> Maaf !!! Program Tidak Ada.</h4>
               <p>Tidak Ada Program </p>
               <p>Silahkan Hubungi Kasubag Program Kembali</p>
               <p>Terimakasih :)</p>
             </div>';
     }else{
       ...
       foreach ($program as $key ){
         if($key['rincian'][0]['paguprogram'][0]['blnskr']==0){
           $capaianprog ='<span class="badge bg-gray disabled color-palette pull-right">&nbspTidak Ada Kas&nbsp</span>';

         }elseif($key['rincian'][0]['prsnrealskrprog'] < 80){
           $capaianprog ='<span class="badge bg-red pull-right">Belum Tercapai</span>';

         }else{
           $capaianprog ='<span class="badge bg-blue pull-right">Sudah Tercapai</span>';

         }
         echo ' <a href="javascript:void(0)" class="list-group-item" data-toggle="collapse" data-target="#'.$key['idprog'].'" data-parent="#menu"> <i class="fa fa-chevron-right"></i> <b>'.$key['nmprog'].'</b> '.$capaianprog.'</a>';
         ...
         <div class="row">
           ...
           <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <table class="table table-bordered " style="font-size: 12px; '.$style.'">
                              <thead >
                                <tr class="bg-gray-active color-palette">
                                  <th rowspan="2" style="vertical-align : middle;text-align:center; ">PAGU PROGRAM TAHUN <span style=" text-transform: uppercase;"><?php echo $tahun ?></span></th>
                                  <th colspan="3" style="vertical-align : middle;text-align:center; " >REALISASI s/d BULAN <span style=" text-transform: uppercase;"><?php echo $bulan?></span></th>
                                  <th colspan="3" style="vertical-align : middle;text-align:center; " >REALISASI BULAN <span style=" text-transform: uppercase;"><?php echo $bulan?></span></th>
                                ...
                                <tr class="bg-green allSides scaled">
                                  <th  style="vertical-align : middle;text-align:center;margin"><?php echo $this->template->rupiah($key['rincian'][0]['paguprogram'][0]['tahun'])?></th>
                                  <th style="vertical-align : middle;text-align:center;" ><?php echo $this->template->rupiah($key['rincian'][0]['paguprogram'][0]['blnsdskr'])?></th>
                                  <th style="vertical-align : middle;text-align:center;" ><?php echo $this->template->rupiah($key['rincian'][0]['realsdprog'])?></th>
                                  <th style="vertical-align : middle;text-align:center;" ><?php echo $key['rincian'][0]['prsnrealsdprog'].' %'?></th>
                                  <th style="vertical-align : middle;text-align:center;" ><?php echo $this->template->rupiah($key['rincian'][0]['paguprogram'][0]['blnskr'])?></th>
                                  <th style="vertical-align : middle;text-align:center;" ><?php echo $this->template->rupiah($key['rincian'][0]['realbulnskrprog'])?></th>
                                  <th style="vertical-align : middle;text-align:center;" ><?php echo $key['rincian'][0]['prsnrealskrprog'].' %'?></th>
                                </tr>
          ...
          <?php
          echo '<table class="table table-bordered table-striped table-condensed " style="font-size: 12px; ">
                    <thead class="bg-gray-active color-palette">
                      <tr>
                        ...
                        <th rowspan="3" style="vertical-align : middle;text-align:center; width: 10%">KPA</th>
                        <th rowspan="3" style="vertical-align : middle;text-align:center; width: 10%">PPTK</th>
                        <th colspan="4" style="vertical-align : middle;text-align:center;">Keuangan s/d Bulan '.$bulan.'</th>
                        <th colspan="2" style="vertical-align : middle;text-align:center;">Fisik s/d Bulan '.$bulan.'</th>
                        <th rowspan="3" style="vertical-align : middle;text-align:center; width: 8%;">Status</th>
                        <th rowspan="3" style="vertical-align : middle;text-align:center;width: 7%;">Rincian Realisasi Bulan '.$bulan.'</th>
                      </tr>
                      <tr>
                      ...
                      <tbody>';
                      foreach ($key['rincian'][0]['keg'] as $x => $value) {
                        ...
                        if($fns==1){
                          //unit atau opd yang evaluasi terakhir sampai KPA saja Maka status e 1 , misalkan kesbangpol
                          ...
                          $alert=$x;
                            ...
                            $alert=$x;
                          //  $capaian ='<span class="badge bg-gray disabled color-palette pull-right">&nbsp&nbsp&nbsp&nbspBlm Realisasi&nbsp&nbsp&nbsp&nbsp</span>';

                          }


                        }else{
                          if($value['stat_terskn']==3 ){
                          //  $alert='<span class="badge bg-blue">'.$x.'</span>';
                          $alert=$x;
                        ...
                        echo '<tr>
                                ...
                                <td style="vertical-align : middle;">'.$value['ppk'].'</td>
                                ...
                                <td style="vertical-align : middle; text-align:center"><button class="btn margin '.$btndis.'" data-idbln='.$idbln.' data-nmbln='.$bulan.' data-kdkeg='.$value['kdkeg'].'>Detail<div class="ripple-container"></div></button></td>
  ...
  $(document).ready(function() {
      ...
      $(".btn-detail").click(function() {
         ...
         Pace.track (function (){
           ...
           $.ajax ({
             url: base_url+"Cpanel/json-detail-realisasi/",
             type: "POST",
             data: {
               token   : token,
               thn : thn,
